  ...
  <div class="mx-auto">
    <div class="wrap">
      <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
              onclick="window.location='../LosingEndings/LOSE3.jsp'"><%out.print(AnswerConstructor.getAnswer(26)); %></button>
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='../WinningEndings/WIN2.jsp'"><%out.print(AnswerConstructor.getAnswer(27)); %></button>
    </div>
  </div>
</div>
</body>
