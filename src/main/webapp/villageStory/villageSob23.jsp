...
<div class="image-bg-sawmill">
    ...
    <div>
        <hr class="my-4">
        <p class="lead" style="margin-left: 200px; margin-right: 200px"><% out.print(PageConstructor.getPage(41));%></p>
        <hr class="my-4">
    ...
    <div class="mx-auto">
        <div class="wrap">
            ...
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='${pageContext.request.contextPath}/LosingEndings/LOSE3.jsp'"><%out.print(AnswerConstructor.getAnswer(30)); %></button>
        </div>
    </div>
</div>
</body>
