  ...
  <div class="mx-auto">
    <div class="wrap">
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='villageSob23.jsp'"><%out.print(AnswerConstructor.getAnswer(12)); %></button>
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='villageSob24.jsp'"><%out.print(AnswerConstructor.getAnswer(13)); %></button>
    </div>
  </div>
</div>
</body>
