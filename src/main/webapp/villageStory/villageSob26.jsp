  ...
  <div class="mx-auto">
    <div class="wrap">
      <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
              onclick="window.location='villageSob23.jsp'"><%out.print(AnswerConstructor.getAnswer(7)); %></button>
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='../LosingEndings/LOSE2.jsp'"><%out.print(AnswerConstructor.getAnswer(8)); %></button>
      <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
              onclick="window.location='../WinningEndings/WIN1.jsp'"><%out.print(AnswerConstructor.getAnswer(9)); %></button>
