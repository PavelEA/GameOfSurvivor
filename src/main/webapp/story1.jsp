    ...
    <div class="mx-auto">
        <div class="wrap">
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='villageStory/village.jsp'"><%out.print(AnswerConstructor.getAnswer(1)); %></button>
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='forestStory/forest.jsp'"><%out.print(AnswerConstructor.getAnswer(2)); %></button>
            <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
                    onclick="window.location='sawmillStory/sawmill.jsp'"><%out.print(AnswerConstructor.getAnswer(3)); %></button>
        </div>
    </div>
</div>
</body>
