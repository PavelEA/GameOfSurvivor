  ...
  <div class="mx-auto">
    <div class="wrap">
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='sawmillSob14.jsp'"><%out.print(AnswerConstructor.getAnswer(4)); %></button>
      <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
              onclick="window.location='sawmillSob15.jsp'"><%out.print(AnswerConstructor.getAnswer(5)); %></button>
      <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
              onclick="window.location='sawmillSob14.jsp'"><%out.print(AnswerConstructor.getAnswer(6)); %></button>
    </div>
  </div>
</div>
</body>
