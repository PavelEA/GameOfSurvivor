    ...
    <div class="mx-auto">
        <div class="wrap">
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='sawmillSob12.jsp'"><%out.print(AnswerConstructor.getAnswer(20)); %></button>
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='../villageStory/villageSob25.jsp'"><%out.print(AnswerConstructor.getAnswer(2)); %></button>
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='sawmillSob13.jsp'"><%out.print(AnswerConstructor.getAnswer(1)); %></button>
        </div>
    </div>
</div>
</body>
