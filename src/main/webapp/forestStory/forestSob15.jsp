  ...
  <div class="mx-auto">
    <div class="wrap">
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='../sawmillStory/sawmillSob16.jsp'"><%out.print(AnswerConstructor.getAnswer(14)); %></button>
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='../sawmillStory/sawmillSob17.jsp'"><%out.print(AnswerConstructor.getAnswer(15)); %></button>
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='../sawmillStory/sawmillSob18.jsp'"><%out.print(AnswerConstructor.getAnswer(16)); %></button>
    </div>
  </div>
</div>
</body>
