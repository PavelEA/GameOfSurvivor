  ...
  <div class="mx-auto">
    <div class="wrap">
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='forestSob17.jsp'"><%out.print(AnswerConstructor.getAnswer(18)); %></button>
      <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
              onclick="window.location='forestSob16.jsp'"><%out.print(AnswerConstructor.getAnswer(19)); %></button>
    </div>
  </div>
</div>
</body>
