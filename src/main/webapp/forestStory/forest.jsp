    ...
    <div class="mx-auto">
        <div class="wrap">
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='forestSob12.jsp'"><%out.print(AnswerConstructor.getAnswer(10)); %></button>
            <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
                    onclick="window.location='forestSob13.jsp'"><%out.print(AnswerConstructor.getAnswer(11)); %></button>
        </div>
    </div>
</div>
</body>
