    ...
    <div class="mx-auto">
        <div class="wrap">
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='${pageContext.request.contextPath}/villageStory/villageSob8.jsp'"><%out.print(AnswerConstructor.getAnswer(14)); %></button>
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='${pageContext.request.contextPath}/villageStory/villageSob20.jsp'"><%out.print(AnswerConstructor.getAnswer(15)); %></button>
            <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
                    onclick="window.location='${pageContext.request.contextPath}/villageStory/villageSob21.jsp'"><%out.print(AnswerConstructor.getAnswer(16)); %></button>
        </div>
    </div>
</div>
</body>
