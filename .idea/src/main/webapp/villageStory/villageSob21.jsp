    ...
    <div class="mx-auto">
        <div class="wrap">
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='${pageContext.request.contextPath}/LosingEndings/WIN1.jsp'"><%out.print(AnswerConstructor.getAnswer(26)); %></button>
            <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
                    onclick="window.location='${pageContext.request.contextPath}/WinningEndings/WIN2.jsp'"><%out.print(AnswerConstructor.getAnswer(29)); %></button>
        </div>
    </div>
</div>
</body>
