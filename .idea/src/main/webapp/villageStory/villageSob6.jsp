...
<div class="image-bg-village">
  ...
  <div>
    <hr class="my-4">
    <p class="lead" style="margin-left: 200px; margin-right: 200px"><% out.print(PageConstructor.getPage(6));%></p>
    <hr class="my-4">
  ...
  <div class="mx-auto">
    <div class="wrap">
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='${pageContext.request.contextPath}/villageStory/villageSob23.jsp'"><%out.print(AnswerConstructor.getAnswer(12)); %></button>
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='${pageContext.request.contextPath}/villageStory/villageSob24.jsp'"><%out.print(AnswerConstructor.getAnswer(13)); %></button>
    </div>
  </div>
</div>
</body>
