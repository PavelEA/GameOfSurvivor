...
<div class="image-bg-sh-house-in">
    ...
    <div>
        <hr class="my-4">
        <p class="lead" style="margin-left: 200px; margin-right: 200px"><% out.print(PageConstructor.getPage(32));%></p>
        <hr class="my-4">
    ...
    <div class="mx-auto">
        <div class="wrap">
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='${pageContext.request.contextPath}/WinningEndings/WIN2.jsp'">Далее</button>
        </div>
    </div>
</div>
</body>
