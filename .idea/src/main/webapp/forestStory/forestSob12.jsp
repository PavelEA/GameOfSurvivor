...
<div class="image-bg-forest">
  ...
  <div>
    <hr class="my-4">
    <p class="lead" style="margin-left: 200px; margin-right: 200px"><% out.print(PageConstructor.getPage(12));%></p>
    <hr class="my-4">
  ...
  <div class="mx-auto">
    <div class="wrap">
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='${pageContext.request.contextPath}/forestStory/forestSob17.jsp'"><%out.print(AnswerConstructor.getAnswer(18)); %></button>
      <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
              onclick="window.location='${pageContext.request.contextPath}/forestStory/forestSob16.jsp'"><%out.print(AnswerConstructor.getAnswer(19)); %></button>
    </div>
  </div>
</div>
</body>
