  ...
  <div class="mx-auto">
    <div class="wrap">
      <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
              onclick="window.location='${pageContext.request.contextPath}/LosingEndings/LOSE4.jsp'"><%out.print(AnswerConstructor.getAnswer(21)); %></button>
      <button class="button" style="margin:0 25% ;position:relative;margin-top: 20px"
              onclick="window.location='${pageContext.request.contextPath}/forestStory/forestSob15.jsp'"><%out.print(AnswerConstructor.getAnswer(24)); %></button>
    </div>
  </div>
</div>
</body>
