...
<div class="jumbotron">
  ...
  <hr class="my-4">
  <p class="nav"><% out.print(PageConstructor.getPage(31));%></p>
  <br><br><br>
  <div class="mx-auto">
    <button class="btnGreen" onclick="window.location='${pageContext.request.contextPath}/WinningEndings/WIN4.jsp'">Далее</button>
  </div>
</div>
</body>
</html>