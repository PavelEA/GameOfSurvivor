    ...
    <div class="mx-auto">
        <div class="wrap">
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='${pageContext.request.contextPath}/sawmillStory/sawmillSob9.jsp'"><%out.print(AnswerConstructor.getAnswer(7)); %></button>
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
            ...
            <button class="button" style="margin:0 25%;position:relative;margin-top: 20px"
                    onclick="window.location='${pageContext.request.contextPath}/sawmillStory/sawmillSob11.jsp'"><%out.print(AnswerConstructor.getAnswer(9)); %></button>
        </div>
    </div>
</div>
</body>
